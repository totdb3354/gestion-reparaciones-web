 ...
 *  resto de la rama es una defensa para cualquier `ConexionError` construido sin él, y entonces vale más su
 *  `message` (puede ser más concreto que el genérico) que el texto de siempre. */
